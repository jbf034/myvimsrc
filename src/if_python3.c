...
#define PyString_AsBytes(obj) PyUnicode_AsEncodedString(obj, (char *)p_enc, CODEC_ERROR_HANDLER);
...
DoPy3Command(exarg_T *eap, const char *cmd)
{
    ...
    cmdstr = PyUnicode_Decode(cmd, strlen(cmd), (char *)p_enc, CODEC_ERROR_HANDLER);
